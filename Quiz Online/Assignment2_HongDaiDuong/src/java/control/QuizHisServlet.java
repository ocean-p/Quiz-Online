 ...
 * @author DELL
 */
@WebServlet(name = "QuizHisServlet", urlPatterns = {"/QuizHisServlet"})
public class QuizHisServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(s.getAttribute("e") != null){
                ...
                int page = SubmitDAO.getNumberPage(email);
                request.setAttribute("page", page);
                String index = request.getParameter("index");
                if(index == null){
                    index = "1";
                }
                ArrayList<Submit> sm = SubmitDAO.getSubmitByEmail(email, Integer.parseInt(index));
