...
public class DetailServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<SubmitDetail> smd = SubmitDetailDAO.getDetailById(id);
            request.setAttribute("detail", smd);
            Submit sm = SubmitDAO.getSubmitById(id);
            Subject sj = SubjectDAO.getSubjectById(String.valueOf(sm.getSubjectid()));
